...
def calculates_results_stats(results_dic):
    ...
    pct_match = (n_match/results_stats_dic['n_images']) * 100.0
    pct_correct_dogs = (n_correct_dogs/results_stats_dic['n_dogs_img']) * 100.0
    pct_correct_breed = (n_correct_breed/results_stats_dic['n_dogs_img']) * 100.0
    pct_correct_notdogs = (n_correct_notdogs/results_stats_dic['n_notdogs_img']) * 100.0
